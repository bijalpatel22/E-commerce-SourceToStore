...
@WebServlet("/accountloginr")
public class AccountLoginR extends HttpServlet {
	
	    private static final long serialVersionUID = 1L;
	    
	    protected RetailersDao userdao;
	    
	    @Override
		public void init() throws ServletException {
			userdao = RetailersDao.getInstance();
		}
		...
		public void doGet(HttpServletRequest req, HttpServletResponse resp)
	        ...
	        req.getRequestDispatcher("/AccountLoginR.jsp").forward(req, resp);
		}
